...
/**
 * R-2025-016 · Exonération CO₂ électrique / hydrogène (CIBS L. 421-124) ·
 * reconduction stricte R-2024-016 (texte inchangé depuis 01/01/2022).
 *
 ...
 */
final readonly class R2025_016_ElectricHydrogen implements ExemptionRule
{
    use AnnualRuleTrait;
    ...
    {
        return 'Véhicules électriques, hydrogène, ou électrique + hydrogène exclusifs - exonération totale CO₂. Reconduction stricte 2024.';
    }
    ...
    public function legalBasis(): array
    {
        return [
            [
                'type' => 'CIBS',
                'article' => 'L. 421-124',
                'url' => 'https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000044602971/2025-01-01',
    ...
    public function pedagogicalContent(): RulePedagogicalContent
    {
        return new RulePedagogicalContent(
            ...
            effect: "Taxe CO₂ = 0 € au titre de l'article L. 421-124. Pour les polluants, le véhicule est catégorie E → 0 € par effet du barème (voir R-2025-014).",
            example: 'Tesla Model 3 électrique, utilisée 365/365 jours par ACME en 2025 : taxe CO₂ 0 € + taxe polluants 0 € = total 0,00 €.',
        );
    }
}
