...
namespace App\Fiscal\Year2026\Abatement;
...
final readonly class R2026_023_E85Abatement implements AbatementRule
{
    ...
    {
        return 'Abattement E85';
    }

    public function description(): string
    {
        return "Pour les véhicules dont la source d'énergie comprend le superéthanol E85 (rubrique P.3 du CI ∈ {FE, FG, FN, FL, FH, FR, FQ, FM, FP}) · abattement de 40 % sur les émissions CO₂ (WLTP/NEDC) sous plafond 250 g/km, OU de 2 CV sur la puissance administrative sous plafond 12 CV. Modifie la base d'entrée des barèmes CO₂ avant tarification. Reconduit 2025 → 2026 sans modification matérielle (CIBS L. 421-125 stable).";
    }
    ...
    public function legalBasis(): array
    {
        return [
            [
                'type' => 'CIBS',
                'article' => 'L. 421-125',
                'url' => 'https://www.legifrance.gouv.fr/codes/article_lc/LEGIARTI000048844564/2026-01-01',
    ...
    public function pedagogicalContent(): RulePedagogicalContent
    {
        return new RulePedagogicalContent(
            ...
            title: 'Abattement E85 (reconduit en 2026)',
            pitch: "Les véhicules pouvant rouler au superéthanol E85 bénéficient d'un abattement de 40 % sur les émissions CO₂ ou de 2 CV sur la puissance administrative, sous plafonds. Mécanique identique à 2025, mais le gain économique croît mécaniquement avec le durcissement des barèmes CO₂ 2026.",
            ...
            example: 'Renault Captur flex-fuel E85 WLTP 130 g/km en 2026 : co2_retenu = 130 × 0,60 = 78 g/km. Barème WLTP 2026 sur 78 g/km = 132 € (vs 683 € sans abattement, économie 551 €/an).',
        );
    }
}
