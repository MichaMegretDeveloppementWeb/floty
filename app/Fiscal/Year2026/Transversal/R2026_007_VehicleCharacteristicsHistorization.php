...
final readonly class R2026_007_VehicleCharacteristicsHistorization implements InformativeRule
{
    ...
    {
        return "Application de la version effective des caractéristiques fiscales à chaque jour d'affectation. Reconduction stricte 2025 → 2026 (principe architectural ADR-0021).";
    }
