...
/**
 * Création d'un véhicule + ses caractéristiques fiscales initiales,
 * dans une transaction atomique.
 *
 * Encapsule la logique transactionnelle qui vivait précédemment dans
 * `VehicleController::store` — extraite ici pour respecter la règle
 * « controllers ne touchent pas Eloquent ».
 */
final class StoreVehicleService
{
