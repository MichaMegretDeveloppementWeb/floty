...
final class FiscalRulesSeeder extends Seeder
{
    ...
    private function rules(): array
    {
        ...
        $cibs = fn (string $article): array => [
            ['type' => 'CIBS', 'article' => $article],
        ];
        ...
        return [
            ...
            [
                ...
                'taxes_concerned' => $both,
                'legal_basis' => [
                    ['type' => 'CIBS', 'article' => 'L. 421-128'],
                    ['type' => 'CIBS', 'article' => 'L. 421-140'],
                ],
                'display_order' => 20,
            ],
            [
            ...
            [
                ...
                'description' => "Contrôle de cohérence entre la catégorie polluants calculée et la vignette Crit'Air attendue (alerte, non bloquant).",
                'rule_type' => RuleType::Transversal,
                'taxes_concerned' => $pol,
                'legal_basis' => [['type' => 'BOFIP', 'reference' => 'BOI-AIS-MOB-10-30-20-20240710', 'paragraph' => '§ 270']],
                'display_order' => 24,
            ],
        ];
    }
    ...
    private function enrich(array $rule): array
    {
        return [
            ...
            'code_reference' => 'app/Fiscal/Rules/2024/'.str_replace('-', '_', $rule['rule_code']).'.php',
