...
const quickLinks: QuickLink[] = [
    ...
    {
        label: 'Flotte',
        description: 'Véhicules enregistrés, caractéristiques fiscales et taxes annuelles.',
        href: '/app/vehicles',
        icon: Car,
    },
    {
        label: 'Entreprises',
        description: 'Clients utilisateurs de la flotte, jours cumulés et taxes par entreprise.',
        href: '/app/companies',
        icon: Building2,
    },
    {
