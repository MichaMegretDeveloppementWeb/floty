...
/**
 * R-2026-003 · Arrondi half-up commercial · règle marqueur · reconduction
 * stricte R-2025-003.
 *
 ...
 */
final class R2026_003_FinalRoundingTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function apply_ajoute_le_rule_code_dans_applied_rules(): void
    {
        ...
        $result = (new R2026_003_FinalRounding)->apply($context);

        self::assertContains('R-2026-003', $result->appliedRuleCodes);
    }
    ...
    public function apply_est_idempotent_sur_les_montants(): void
    {
        ...
        $rule = new R2026_003_FinalRounding;
