...
namespace Tests\Unit\Fiscal\Year2026\Abatement;
...
/**
 * Goldens BOFiP pour l'abattement E85 2026 (CIBS L. 421-125 stable
 * depuis 01/01/2025 · reconduction stricte sans modification matérielle
 * audit Chrome live 15/05/2026).
 *
 * Mécanique testée ·
 ...
 */
final class R2026_023_E85AbatementTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function pas_d_abattement_si_flag_e85_est_false(): void
    {
        ...
        $result = (new R2026_023_E85Abatement)->abate($context);
    ...
    public function ne_modifie_pas_la_vfc_originale(): void
    {
        ...
        (new R2026_023_E85Abatement)->abate($context);
    ...
    {
        $rule = new R2026_023_E85Abatement;
        self::assertSame('R-2026-023', $rule->ruleCode());
