...
namespace Tests\Unit\Fiscal\Year2025\Classification;
...
/**
 * Couvre la cascade de classification fiscale (R-2025-004, CIBS L. 421-2)
 ...
 * sorti du champ.
 */
final class R2025_004_FiscalTypeQualificationTest extends TestCase
{
    use RefreshDatabase;

    private R2025_004_FiscalTypeQualification $rule;

    protected function setUp(): void
    {
        parent::setUp();
        $this->rule = new R2025_004_FiscalTypeQualification;
    }
