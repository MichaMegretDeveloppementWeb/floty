...
/**
 * Suite exhaustive des goldens BOFiP 2025 (audit user 14/05/2026).
 *
 * Complète `R2025_PricingScalesTest` et `R2025_023_E85AbatementTest`
 * avec ~80 cas custom calculés à la main, couvrant toutes les bordures
 * de tranches + transitions + cas extrêmes + combinaisons E85.
 *
 * Méthode · chaque cas a son calcul détaillé en commentaire. Si le
 * moteur diverge, c'est soit le calcul manuel qui est faux (le revoir
 * ligne par ligne avec le barème Légifrance) soit le moteur qui a un
 * bug (à investiguer).
 *
 * **Référence légale auditée Chrome/WebFetch 14/05/2026** ·
 * - WLTP L. 421-120 v 01/01/2025 (LEGIARTI000048886183)
 * - NEDC L. 421-121 v 01/01/2025 (LEGIARTI000048886368)
 * - PA L. 421-122 v 01/01/2025 (LEGIARTI000048886433)
 * - Polluants L. 421-135 v 31/12/2023 → 01/03/2026 (LEGIARTI000048844528)
 * - E85 L. 421-125 v 01/01/2025 (LEGIARTI000048844564)
 * - BOFiP exemple WLTP 100 g = 193 €
 *   (BOI-AIS-MOB-10-30-20-20250528 § III-A exemple 1)
 */
final class R2025_ExhaustiveGoldensTest extends TestCase
{
    ...
    // ============================================================
    // WLTP · 22 cas exhaustifs (toutes les bordures de tranche
