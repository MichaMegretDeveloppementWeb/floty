...
final class R2025_018And019_StubExemptionsTest extends TestCase
{
    ...
    {
        $rule = new R2025_018_OigExemption;
    ...
    public function r_2024_018_oig_declare_les_2_taxes_concernees(): void
    {
        ...
        self::assertSame('R-2025-018', $rule->ruleCode());
    ...
    {
        $rule = new R2025_019_IndividualBusinessExemption;
        $context = $this->makeContext();
    ...
    public function r_2024_019_entreprise_individuelle_declare_les_2_taxes_concernees(): void
    {
        ...
        self::assertSame('R-2025-019', $rule->ruleCode());
        self::assertCount(2, $rule->taxesConcerned());
    }
