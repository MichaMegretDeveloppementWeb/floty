...
namespace Tests\Unit\Fiscal\Year2024\Transversal;
...
/**
 * Sanity tests pour R-2024-027 · coefficient pondérateur et minoration
 ...
 * contexte inchangé.
 */
final class R2024_027_MileageReimbursementCoefficientTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $rule = new R2024_027_MileageReimbursementCoefficient;
    ...
    public function declare_les_2_taxes_concernees(): void
    {
        ...
        self::assertSame('R-2024-027', $rule->ruleCode());
