...
/**
 * Couvre le decorator {@see R2024_021_WithOptOuts} (Phase 11 D5.1).
 *
 * Sémantique :
 ...
 *   - `ruleCode` reste `R-2024-021` (même règle légale)
 */
final class R2024_021_WithOptOutsTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        parent::setUp();
        $this->wrapped = new R2024_021_ShortTermRental;
    ...
    {
        $decorator = new R2024_021_WithOptOuts($this->wrapped, []);
    ...
    public function avec_opt_outs_les_contrats_dans_la_liste_ne_sont_plus_lcd(): void
    {
        ...
        $decorator = new R2024_021_WithOptOuts($this->wrapped, [$lcd1->id]);
    ...
    public function evaluate_sans_opt_outs_produit_le_meme_verdict_que_la_regle_wrappee(): void
    {
        ...
        $decoratorVerdict = (new R2024_021_WithOptOuts($this->wrapped, []))->evaluate($context);
    ...
    public function evaluate_avec_tous_les_lcd_opt_out_renvoie_not_exempt(): void
    {
        ...
        $decorator = new R2024_021_WithOptOuts($this->wrapped, [$lcd->id]);
    ...
    {
        $decorator = new R2024_021_WithOptOuts($this->wrapped, [42]);

        self::assertSame('R-2024-021', $decorator->ruleCode());
