...
final class UnavailabilityObserverTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function indispo_reductrice_invalide(): void
    {
        ...
        self::assertSame(
            InvalidationReasonType::UnavailabilityCreated->value,
    ...
    public function deletion_d_indispo_reductrice_invalide(): void
    {
        ...
        self::assertTrue($fresh->is_obsolete);
        self::assertSame(
            InvalidationReasonType::UnavailabilityDeleted->value,
            $fresh->obsolete_reasons[0]['type'],
        );
    }
