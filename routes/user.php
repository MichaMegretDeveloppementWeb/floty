...
Route::middleware('auth')
    ...
    ->group(function (): void {
        ...
        // Client-side debounce + minimum 2 characters; throttle is a guard
        // against abuse.
        ...
        // Invoices
        //
        // PDF-generating mutations are throttled to 6/min · each call
        // renders dompdf + writes the file (~0.5-2 s).
        Route::get('/invoices', [InvoiceController::class, 'index'])->name('invoices.index');
        Route::post('/invoices/generate', [InvoiceController::class, 'generate'])
            ->middleware('throttle:6,1')
            ->name('invoices.generate');
        // Bulk generation · one call renders up to 12 PDFs sequentially.
        // Throttle 2/min absorbs retries after partial failure while
        // capping server saturation.
        ...
        //
        // Cluster mutations are throttled to 30/min. PDF-generating
        // mutations (generate, regenerate) are throttled to 6/min · each
        // call renders DomPDF and writes the file.
        //
